                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16 items-center">
                        ...
                        <div className="hidden md:flex items-center space-x-6">
                            ...
                            <Link to="/contest" className="bg-white/20 text-white px-3 py-2 rounded-md text-sm font-medium">Contests</Link>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                {!loading && filteredContests.length === 0 && (
                    <div className="text-center py-16 backdrop-blur-sm bg-white/10 rounded-2xl border border-white/20">
                        <svg className="mx-auto h-12 w-12 text-indigo-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            >
                                ...
                                <div className="p-6">
                                    ...
                                    <p className="text-indigo-100 mb-4 line-clamp-2">
                                        {contest.description || "Join this exciting quiz contest to test your knowledge."}
                                    </p>

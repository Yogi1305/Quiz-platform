...
const QuizResults = () => {
  ...
  const { contestId } = useParams(); // Assuming you use React Router and have contestId in URL
  ...
  useEffect(() => {
    const fetchResults = async () => {
      try {
        ...
        setTotalParticipants(response.data.totalParticipants || response.data.results.length);
